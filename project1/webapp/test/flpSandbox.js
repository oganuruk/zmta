		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zmtaproject1project1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zmtaproject1project1-display": {
								"semanticObject": "zmtaproject1project1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmta.project1.project1",
									"url": sap.ui.require.toUrl("zmta/project1/project1")
								}
							}
						}
					}
